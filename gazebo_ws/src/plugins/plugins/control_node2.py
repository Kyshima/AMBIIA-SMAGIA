...
class RobotMover(Node):
    def __init__(self):
        ...
        self.target_x = -8.85  # Target x position
        self.target_y = 1.22  # Target y position
        self.current_x = 0.0
        self.current_y = 0.0
        ...
        mqtt_port = 1883
        self.mqtt_topic_command = "Coordinates2"
        ...
        mqtt_broker = "127.0.0.1"
        mqtt_port = 1883
        self.mqtt_topic_command2 = "target_coordinates2"
